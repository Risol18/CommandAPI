...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        public void PutCommandItem_AttributeUnchanged_WhenInvalidObject()
        {
            ...
            var command2 = new Command { Id = command.Id, HowTo = "UPDATED", Platform = "UPDATED", CommandLine = "UPDATED" };
        ...
        [Fact]
        public void DeleteCommandItem_Returns404NotFound_WhenNoValidObjectID()
        {
            //Arrange
